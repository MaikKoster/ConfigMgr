...
' //
' // Download: https://github.com/MaikKoster/ConfigMgr/tree/master/TaskSequenceMonitor
' //  
' //
...
Sub AddXMLHeader (XML, User, EventType)
    ...
    sHeader = sHeader & "Check https://github.com/MaikKoster/ConfigMgr for Updates." & vbCrLf & vbCrLf
